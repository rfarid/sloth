import coloredFixedRatioRectItemWithLabel_def
...
LABELS = (
    {
        ...
        'text':     'FixedRatioRect_1',
    },
    {
        'attributes': {
            'class':      'FixedRatioRectCustom1',
        },
        'inserter': coloredFixedRatioRectItemWithLabel_def.FixedRatioRectItemInserter_custom1,
        'item':     coloredFixedRatioRectItemWithLabel_def.FixedRatioRectItem_cutom(color=Qt.darkBlue,label="1**"),
        'hotkey':   'f',
        'text':     'FixedRatioRect_222x74',
    },
    {
        'attributes': {
            'class':      'FixedRatioRectCustom2',
        },
        'inserter': coloredFixedRatioRectItemWithLabel_def.FixedRatioRectItemInserter_custom2,
        'item':     coloredFixedRatioRectItemWithLabel_def.FixedRatioRectItem_cutom(color=Qt.darkGreen,label="2**"),
        'hotkey':   'g',
        'text':     'FixedRatioRect_444x148',
    },
    {
        'attributes': {
            'class':      'FixedRatioRectCustom3',
        },
        'inserter': coloredFixedRatioRectItemWithLabel_def.FixedRatioRectItemInserter_custom3,
        'item':     coloredFixedRatioRectItemWithLabel_def.FixedRatioRectItem_cutom(color=Qt.darkRed,label="3**"),
        'hotkey':   'h',
